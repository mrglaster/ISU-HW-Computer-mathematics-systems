...
from modules.interpolation_extrapolation.partial_linear_interpolation import *
from modules.interpolation_extrapolation.lagrange_polynomial import *
...
def test_linear_partial_interpolation():
    ...
    assert solve_particular_linear_interpolation(test_data, values_calculus) == answer
